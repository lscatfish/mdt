# baseline-upstream 会话开头核对

- 会话文件：`dsh-session-session-347ab4b5-2377-456a-b0fb-102550be57a8.zip`
- 会话 ID：`session-347ab4b5-2377-456a-b0fb-102550be57a8`
- 创建时预设（session 头部 agentPreset）：`zero-anchored-standard-b`
- 会话内切换（agent-preset/selected）：`anchored-standard → zero-anchored-standard-b → anchored-standard`
